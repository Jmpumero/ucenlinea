...
@section('content')
    ...
    <div class="card card-notifiacion table-responsive" id="c_formaciones">
        ...
        <div class=" card-body table-responsive-sm" style="text-align:center;">
            ...
            <button style="margin-top:1%;" type="button" name="" id="btn_confirm_f" class="btn  btn-success" btn-lg
                btn-block" disabled=true>Confirmar</button>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class=" card-body table-responsive-sm" style="text-align:center; display:none;">
                            ...
                            <button style="margin-top:1%;" type="button" name="" id="btn_confirm_f" class="btn  btn-success"
                                btn-lg btn-block" disabled=true>Confirmar</button>
                        </div>
                        ...
                        <div id="card_postulados" class=" card card-outline card-blue table-responsive-sm">
                            <div class="card-body  table-responsive" style="height: 363px">
                                ...
                                <table id="select_new_postulado" class="table table-striped table-responsive-sm text-center"
                                    style="height: 245px">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 15%">
                        ...
                        <!--- tabla supervisor-->
                        <div style="display: none;" id="card_supervisor"
                            class=" card card-outline card-green table-responsive-sm">
                            <div class="card-body" style="height: 300px">

                                <table id="select_new_supervisor"
                                    class="table table-striped table-responsive-sm text-center" style="height: 215px">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 15%">
                                                C.I
                            ...
                            <div class="card-footer">
                                <button id="btn_atras_M" class="btn btn-outline-primary"><i
                    ...
                    <div class="modal-footer">
                        <button id="btn_closed_m" type="button" class="btn btn-outline-danger"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="btn_closed_m_excel" type="button" class="btn btn-outline-danger"
                                data-dismiss="modal">Cerrar</button>
                            </form>
                        </div>
                    </div>
                ...
                <div id="modal_e" class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div style="display: none;" id="div_t_errores"
                                class="card-body table-responsive card-outline card-danger  ">

                                <div class="table-responsive " style="height: 250px;">
                                    <!--para q pueda tener scroll-->
                            ...
                            <div style="display: none;" id="div_descarga" class="card card-outline card-green ">
                                ...
                                <form action="{{ url('download/export') }}">
                                    ...
                                    <input type="text" name="user_id_download" hidden id="vu_id"
                                        value="{{ Auth::user()->id }}">
                                    <button id="btn_download_excel" type="submit" class="btn btn-sm btn-outline-primary"><i
                                            style="margin-right: 1%" class="fas fa-file-download fa-3x"></i></button>
                                </form>
                            </div>
